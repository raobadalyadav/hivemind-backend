...
func (c *recommendationServiceClient) GetRecommendedPlans(ctx context.Context, in *GetRecommendedPlansRequest, opts ...grpc.CallOption) (*GetRecommendedPlansResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetRecommendedPlansResponse)
	err := c.cc.Invoke(ctx, RecommendationService_GetRecommendedPlans_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *recommendationServiceClient) GetSmartMatch(ctx context.Context, in *GetSmartMatchRequest, opts ...grpc.CallOption) (*GetSmartMatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSmartMatchResponse)
	err := c.cc.Invoke(ctx, RecommendationService_GetSmartMatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRecommendationServiceServer) GetRecommendedPlans(context.Context, *GetRecommendedPlansRequest) (*GetRecommendedPlansResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecommendedPlans not implemented")
}
...
func _RecommendationService_GetRecommendedPlans_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRecommendedPlansRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).GetRecommendedPlans(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_GetRecommendedPlans_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetRecommendedPlans(ctx, req.(*GetRecommendedPlansRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RecommendationService_GetSmartMatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSmartMatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).GetSmartMatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_GetSmartMatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetSmartMatch(ctx, req.(*GetSmartMatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "social.v1.RecommendationService",
	HandlerType: (*RecommendationServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetRecommendedPlans",
			Handler:    _RecommendationService_GetRecommendedPlans_Handler,
		},
		{
	...
	Metadata: "social/v1/recommendation.proto",
}

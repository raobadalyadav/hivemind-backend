...
func (c *paymentServiceClient) VerifyOrder(ctx context.Context, in *VerifyOrderRequest, opts ...grpc.CallOption) (*Order, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Order)
...
func (c *paymentServiceClient) RefundPayment(ctx context.Context, in *RefundPaymentRequest, opts ...grpc.CallOption) (*Refund, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Refund)
...
func (c *paymentServiceClient) GetMyCreditBalance(ctx context.Context, in *GetMyCreditBalanceRequest, opts ...grpc.CallOption) (*CreditBalance, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreditBalance)
	err := c.cc.Invoke(ctx, PaymentService_GetMyCreditBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) RefundPayment(context.Context, *RefundPaymentRequest) (*Refund, error) {
	return nil, status.Error(codes.Unimplemented, "method RefundPayment not implemented")
}
func (UnimplementedPaymentServiceServer) GetMyCreditBalance(context.Context, *GetMyCreditBalanceRequest) (*CreditBalance, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMyCreditBalance not implemented")
}
...
func _PaymentService_VerifyOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).VerifyOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_VerifyOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PaymentService_GetMyCreditBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMyCreditBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).GetMyCreditBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_GetMyCreditBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetMyCreditBalance(ctx, req.(*GetMyCreditBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "social.v1.PaymentService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMyCreditBalance",
			Handler:    _PaymentService_GetMyCreditBalance_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "social/v1/payment.proto",
}

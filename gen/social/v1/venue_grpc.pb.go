...
func (c *venueServiceClient) ListMyVenues(ctx context.Context, in *ListMyVenuesRequest, opts ...grpc.CallOption) (*ListMyVenuesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMyVenuesResponse)
	err := c.cc.Invoke(ctx, VenueService_ListMyVenues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *venueServiceClient) GetVenueDashboard(ctx context.Context, in *GetVenueDashboardRequest, opts ...grpc.CallOption) (*VenueDashboard, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VenueDashboard)
	err := c.cc.Invoke(ctx, VenueService_GetVenueDashboard_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedVenueServiceServer) GetVenueDashboard(context.Context, *GetVenueDashboardRequest) (*VenueDashboard, error) {
	return nil, status.Error(codes.Unimplemented, "method GetVenueDashboard not implemented")
}
...
func _VenueService_ListMyVenues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMyVenuesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VenueServiceServer).ListMyVenues(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VenueService_ListMyVenues_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VenueServiceServer).ListMyVenues(ctx, req.(*ListMyVenuesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VenueService_GetVenueDashboard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVenueDashboardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VenueServiceServer).GetVenueDashboard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VenueService_GetVenueDashboard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VenueServiceServer).GetVenueDashboard(ctx, req.(*GetVenueDashboardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VenueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "social.v1.VenueService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVenueDashboard",
			Handler:    _VenueService_GetVenueDashboard_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "social/v1/venue.proto",
}
